...
import (
	...
	"foxhunt.dev/fox/internal/pkg/hash/crypto/blake3"
	"foxhunt.dev/fox/internal/pkg/hash/crypto/shake"
	"foxhunt.dev/fox/internal/pkg/hash/fast/djb2"
	"foxhunt.dev/fox/internal/pkg/hash/fast/xxh"
	"foxhunt.dev/fox/internal/pkg/hash/fuzzy/impfuzzy"
	"foxhunt.dev/fox/internal/pkg/hash/fuzzy/imphash"
	"foxhunt.dev/fox/internal/pkg/hash/other/image"
	"foxhunt.dev/fox/internal/pkg/hash/other/kermit"
	"foxhunt.dev/fox/internal/pkg/hash/windows/lm"
	"foxhunt.dev/fox/internal/pkg/hash/windows/nt"
	"foxhunt.dev/fox/internal/pkg/hash/windows/pe"
